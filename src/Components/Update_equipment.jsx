...
const Update_equipment = () => {
      ...
      console.log(loader_data, item_name);
  ...
  const handleSubmit = (e) => {
    ...
    const product_information = {_id, item_name, category_name, category_name, image, description, price, rating, delivery, customization, status};
            ...
            <div>
              ...
              <div className="relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 pr-3 sm:text-sm border-gray-300 rounded-md py-3 ${
                    errors.categoryName ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : ''
                  }`}
            ...
            <div>
              ...
              <div className="relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 pr-3 sm:text-sm border-gray-300 rounded-md py-3 ${
                    errors.image ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : ''
                  }`}
            ...
            <div>
              ...
              <div className="relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 pr-3 sm:text-sm border-gray-300 rounded-md py-3 ${
                    errors.rating ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : ''
                  }`}
            ...
            <div>
              ...
              <div className="relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 pr-3 sm:text-sm border-gray-300 rounded-md py-3 ${
                    errors.deliveryTime ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : ''
                  }`}
            ...
            <div>
              ...
              <div className="relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 pr-3 sm:text-sm border-gray-300 rounded-md py-3 ${
                    errors.customization ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : ''
                  }`}
